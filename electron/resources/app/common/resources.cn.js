    ...
    (function (_spread) {
        (function (designer) {
            (function (en_res) {
                ...
                en_res.saveFileDialogTitle = "另存为";
                en_res.openFileDialogTitle = "打开";
                en_res.allSpreadFileFilter = 'All Spreadsheet files (*.ssjson *.xlsx *.xls *.csv)';
                en_res.spreadFileFilter = 'SpreadJS files (*.ssjson)';
                en_res.ssJSONToJSFilter = 'Javascript files (*.js)';
                en_res.allExcelFilter = "All Excel files (*.xlsx *.xls)";
                en_res.excelFileFilter = 'Excel 2007 Workbook (*.xlsx)';
                en_res.excelFileFilter2 = 'Excel 97-2003 Workbook (*.xls)';
                ...
                en_res.excelServiceUrlWrong = "Please check Excel Service URL.";

                en_res.noLicense = "No license.Please click LOCK button to active designer for advanced features.";
                en_res.trialLicense = "Trial version ({0} days left). Please click LOCK button to active designer for advanced features.";
                en_res.expiredLicense = "Your license is expired. Please click LOCK button to active designer for advanced features.";
                ...
                en_res.ribbon = {
                    ...
                    home: {
                        ...
                        fontFamily: "字体",
                        fontSize: "文字大小",
                        increaseFontSize: "文字变大",
                        decreaseFontSize: "文字变小",
                        bold: "黑体",
                        italic: "斜体",
                        underline: "下划线",
                        border: "边框",
                    ...
                    view: {
                        ...
                        rowHeader: "标题列",
                        columnHeader: "标题行",
                        verticalGridline: "垂直表格线",
                        horizontalGridline: "水平表格线",
                        tabStrip: "表清单",
                        newTab: "插入表",
                        rowHeaderTip: "显/隐 标题列",
                        columnHeaderTip: "显/隐 标题行",
                        verticalGridlineTip: "显/隐 垂直表格线",
                        horizontalGridlineTip: "显/隐 水平表格线",
                        tabStripTip: "显/隐 表清单",
                        newTabTip: "显/隐 插入表",
                        zoomToSelection: "缩放至 选择区域",
                        zoomToSelection1: "缩放至 选择区域",
                        freezePane: "冻结",
                        freezePane1: "冻结窗格",
                        freezeTopRow: "冻结首行",
                        freezeFirstColumn: "冻结首列",
                        freezeBottomRow: "冻结末行",
                        freezeLastColumn: "冻结末列",
                        unFreezePane: "取消冻结",
				...
				en_res.createChartDialog = {
                    createSparkline: "图表设置",
                    dataRange: "数据范围",
                    locationRange: "显示范围",
                    chooseData: "Choose the data that you want",
                    chooseWhere: "Choose where you want the sparkline to be placed",
                ...
                en_res.insertChartDialog = {
                    createCharts: "插入图表",
                    dataRange: "数据范围:",
                    dataRangeTitle: "数据设置",
                    locationRange: "显示位置:",
                    locationRangeTitle: "样式设置",
                    errorDataRangeMessage: "Please input a valid range",
                    isFormulaChart: "添加公式",
					chartType:"图表类型",
					lineChart:"折线图",
                ...
                en_res.filemenuOptionsDialog = {
                    title: "Options",
                    urlLabel: "Excel Service Url:"
                };
                ...
                sku.spread.designer.res = sku.spread.designer.en_res;
            })(designer.en_res || (designer.en_res = {}));
            var en_res = designer.en_res;
        })(_spread.designer || (_spread.designer = {}));
        var designer = _spread.designer;
