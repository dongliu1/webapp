...
sku; (function(n) { (function(n) { (function(t) {
            var i = function(i) {
                function r() {
                    var n = this,
                    u = {
                ...
                r.prototype._beforeOpen = function(n) {
                    ...
                    n[1] !== undefined && this._element.find(".font-picker").wijfontpicker("option", "customFontStyle", n[1]),
                ...
                r.prototype._init = function() {
                    var i = this,
                    r = t.wrapper.spread;
                    this._element.find(".sample-spread").rexcel(),
                    this._formatNumberSpread = this._element.find(".sample-spread").rexcel("spread"),
                    this._defaultBorderType = !1,
                    this._addFormats = [],
                    this._defaultTime = "3/14/2001 13:30:00",
                    this._borderColor = "Text 1",
                    this._lineStyle = 1,
                    this._moreColorDialog = new t.wijcolorpicker.WijColorDailog,
                    ...
                    this._element.find(".format-tab-li").click(function() {
                        $("button[skudialogtobefocused='true']").focus()
                    }),
                    ...
                    this._element.find(".colorPicker").wijcolorpicker({
                        valueChanged: function(n, r) {
                            ...
                            } else i._element.find(".show-color-span").css("background-color", r.color),
                            i._cacheStyle.backColor(r.color)
                        }
                    }),
                    this._element.find(".border-picker").wijborderpicker({
                    ...
                    this._element.find(".border-picker").wijborderpicker("option", "colorOptions", {
                        showNoFill: !1
                    }),
                    this._element.find(".more-color-button").click(function() {
                        typeof i._moreColorDialog == undefined && (i._moreColorDialog = new t.wijcolorpicker.WijColorDailog, i._moreColorDialog._create()),
                    ...
                    $(this._moreColorDialog).on("dialogClose",
                    function(n, t) {
                        if (t) {
                            var r;
                            r = {
                            ...
                            i._element.find(".colorPicker").wijcolorpicker("option", "selectedItem", this.value),
                    ...
                    this._element.find(".no-color-button").click(function() {
                        i._element.find(".colorPicker").wijcolorpicker("option", "selectedItem", null),
                    ...
                    this._element.find(".border-line-panel").click(function(n) {
                        ...
                        f = o,
                        s = h,
                        a = i._element.find(".border-sheet").rexcel("spread"),
                        v = a.getActiveSheet(),
                        l = v.getSpans(),
                    ...
                    this._element.find(".colorPicker").wijcolorpicker("option", "showThemeColorTitle", !1),
                    this._element.find(".colorPicker").wijcolorpicker("option", "showStandardColorTitle", !1),
                    this._element.find(".colorPicker").wijcolorpicker("option", "showOutline", !1),
                    this._element.find(".colorPicker").wijcolorpicker("option", "showNoFill", !1),
                    this._element.find(".colorPicker").wijcolorpicker("option", "showMoreColors", !1),
                    this._element.find(".colorPicker").wijcolorpicker("option", "themeColors", t.wrapper.getThemeColors()),
                    this._element.find(".border-picker").wijborderpicker("option", "colorOptions", {
                    ...
                    this._element.find(".tab-border-li").click(function() {
                        setTimeout(function() {
                            i._element.find(".border-sheet").rexcel("refresh")
                        },
                        0)
                    })
                },
                ...
                r.prototype.ok = function() {
                    ...
                    if (this._merged && this._merged !== t.BaseMetaObject.indeterminateValue) {
                        for (f = t.wrapper.spread.getActiveSheet(), i = f.getSelections(), u = 0; u < i.length; u++) for (r = u + 1; r < i.length; r++) if (i[u].intersect(i[r].row, i[r].col, i[r].rowCount, i[r].colCount)) {
                ...
                r.prototype._updateFontPickerValue = function(n, i, r) {
                    ...
                    o,
                    e;
                    n && n !== t.BaseMetaObject.indeterminateValue && n !== t.BaseMetaObject.undefinedValue ? (f = t.util.parseFont(n), o = f.fontFamily.split(","), o.length > 1 ? u.wijfontpicker("family", o[0]) : u.wijfontpicker("family", f.fontFamily), u.wijfontpicker("style", f.fontStyle), f.fontSize.indexOf("pt") !== -1 ? u.wijfontpicker("size", f.fontSize.substring(0, f.fontSize.length - 2)) : f.fontSize.indexOf("px") !== -1 ? (e = this._element.find(".sku-wijfontpicker-preview").get(0).style.fontSize, u.wijfontpicker("size", e.substring(0, e.length - 2))) : u.wijfontpicker("size", f.fontSize), u.wijfontpicker("weight", f.fontWeight)) : (u.wijfontpicker("family", ""), u.wijfontpicker("style", ""), u.wijfontpicker("size", ""), u.wijfontpicker("weight", "")),
                    this._fontFamily = undefined,
                    this._fontStyle = undefined,
                    this._fontSize = undefined,
                    this._fontWeight = undefined,
                    i !== t.BaseMetaObject.indeterminateValue && i !== t.BaseMetaObject.undefinedValue ? u.wijfontpicker("color", t.ColorHelper.parse(i, t.wrapper.spread.getActiveSheet().currentTheme().colors())) : u.wijfontpicker("color", null),
                    u.wijfontpicker("colorOption", "themeColors", t.wrapper.getThemeColors()),
                    r & 1 ? (u.wijfontpicker("underline", !0), this._underline = !0) : (u.wijfontpicker("underline", !1), this._underline = !1),
                    r & 2 ? (u.wijfontpicker("strikethrough", !0), this._strikethrough = !0) : (u.wijfontpicker("strikethrough", !1), this._strikethrough = !1)
                },
                r.prototype._updateColorSpan = function(n, i) {
                    var u = this._element.find(n),
                    r;
                    i === t.BaseMetaObject.indeterminateValue || i === t.BaseMetaObject.undefinedValue || i === undefined || i === null ? (u.css("background-color", ""), this._element.find(".colorPicker").wijcolorpicker("option", "selectedItem", null), this._moreColorItem = "rgb(0,0,0)") : (r = t.ColorHelper.parse(i, t.wrapper.spread.getActiveSheet().currentTheme().colors()), this._element.find(".colorPicker").wijcolorpicker("option", "selectedItem", r), u.css("background-color", r.color), this._moreColorItem = r.color)
                },
                r.prototype._createBorderFrame = function(n) {
                    var c = this,
                    l = this,
                    f = !1,
                    e = !1,
                    i, u, r;
                    for (this._element.find(".border-sheet").rexcel(), this._borderSpread = this._element.find(".border-sheet").rexcel("spread"), this._borderSpread.showHorizontalScrollbar(!1), this._borderSpread.showVerticalScrollbar(!1), this._borderSpread.tabStripVisible(!1), this._borderSpread.allowUserResize(!1), i = this._borderSpread.getActiveSheet(), $(i._canvas).unbind("gcmousewheel.gcSheet"), i.currentTheme(t.wrapper.spread.getActiveSheet().currentTheme()), i.setGridlineOptions({
                        showVerticalGridline: !1,
                        showHorizontalGridline: !1
                    }), i.colHeaderVisible = !1, i.rowHeaderVisible = !1, i.canUserDragDrop(!1), i.canUserDragFill(!1), i.selectionBackColor("transparent"), i.selectionBorderColor("transparent"), i.isProtected = !0, i.setColumnCount(4), i.setRowCount(4), i.setValue(1, 1, t.res.formatDialog.sampleText), i.setValue(1, 2, t.res.formatDialog.sampleText), i.setValue(2, 1, t.res.formatDialog.sampleText), i.setValue(2, 2, t.res.formatDialog.sampleText), r = 1; r < 3; r++) for (u = 1; u < 3; u++) i.getCell(r, u).vAlign($.RE.rexcel.VerticalAlign.center),
                    i.getCell(r, u).hAlign($.RE.rexcel.HorizontalAlign.center);
                    i.setRowHeight(0, 2),
                    i.setRowHeight(1, 33),
                    i.setRowHeight(2, 34),
                    i.setRowHeight(3, 1),
                    ...
                    this._element.find(".inside-border-button").button("disable");
                        ...
                        var h = t.wrapper.spread,
                        s = h.getActiveSheet(),
                        o = s.getSelections();
                        for (r = 0; r < o.length; r++) o[r].rowCount > 1 && (e = !0),
                        o[r].colCount > 1 && (f = !0); ! f && e ? (i.addSpan(1, 1, 1, 2), i.addSpan(2, 1, 1, 2), this._element.find(".vertical-middle").hide(), this._element.find(".horizontal-middle").show(), this._element.find(".vertical-inner-line-input").button("disable"), this._element.find(".horizontal-inner-line-input").button("enable"), this._element.find(".inside-border-button").button("enable")) : f && !e ? (i.addSpan(1, 1, 2, 1), i.addSpan(1, 2, 2, 1), this._element.find(".vertical-middle").show(), this._element.find(".horizontal-middle").hide(), this._element.find(".horizontal-inner-line-input").button("disable"), this._element.find(".vertical-inner-line-input").button("enable"), this._element.find(".inside-border-button").button("enable")) : f || e ? (this._element.find(".horizontal-middle").show(), this._element.find(".vertical-middle").show(), this._element.find(".vertical-inner-line-input").button("enable"), this._element.find(".horizontal-inner-line-input").button("enable"), this._element.find(".inside-border-button").button("enable")) : (i.addSpan(1, 1, 2, 2), this._element.find(".horizontal-middle").hide(), this._element.find(".vertical-middle").hide(), this._element.find(".vertical-inner-line-input").button("disable"), this._element.find(".horizontal-inner-line-input").button("disable"), this._element.find(".inside-border-button").button("disable"))
                    }
                    setTimeout(function() {
                        c._element.find(".border-sheet").rexcel("refresh")
                    },
                    0)
                },
                r.prototype._destorySheet = function() {
                    var n = this._element.find(".border-sheet");
                    n.attr("gcuielement") === "sku" && (n.rexcel("destroy"), this._element.find(".border-sheet").html(""))
                },
                ...
                r.prototype._setBorder = function() {
                    var i = this._getBorderType(),
                    r = this._cacheStyle.result();
                    i.topLineBorder ? t.actions.doAction("setBorder", t.wrapper.spread, {
                        lineborder: i.topLineBorder,
                        options: {
                            top: !0
                        }
                    }) : r.borderTop && t.actions.doAction("setBorder", t.wrapper.spread, {
                        lineborder: new n.LineBorder,
                        options: {
                            top: !0
                        }
                    }),
                    i.bottomLineBorder ? t.actions.doAction("setBorder", t.wrapper.spread, {
                        lineborder: i.bottomLineBorder,
                        options: {
                            bottom: !0
                        }
                    }) : r.borderBottom && t.actions.doAction("setBorder", t.wrapper.spread, {
                        lineborder: new n.LineBorder,
                        options: {
                            bottom: !0
                        }
                    }),
                    i.rightLineBorder ? t.actions.doAction("setBorder", t.wrapper.spread, {
                        lineborder: i.rightLineBorder,
                        options: {
                            right: !0
                        }
                    }) : r.borderRight && t.actions.doAction("setBorder", t.wrapper.spread, {
                        lineborder: new n.LineBorder,
                        options: {
                            right: !0
                        }
                    }),
                    i.leftLineBorder ? t.actions.doAction("setBorder", t.wrapper.spread, {
                        lineborder: i.leftLineBorder,
                        options: {
                            left: !0
                        }
                    }) : r.borderLeft && t.actions.doAction("setBorder", t.wrapper.spread, {
                        lineborder: new n.LineBorder,
                        options: {
                            left: !0
                        }
                    }),
                    i.innerHorizontalLineBorder && t.actions.doAction("setBorder", t.wrapper.spread, {
                        lineborder: i.innerHorizontalLineBorder,
                        options: {
                            innerHorizontal: !0
                        }
                    }),
                    i.innerVerticalLineBorder && t.actions.doAction("setBorder", t.wrapper.spread, {
                        lineborder: i.innerVerticalLineBorder,
                        options: {
                            innerVertical: !0
                        }
                    })
                ...
                r.prototype._getSelectionsBorderType = function() {
                    ...
                    for (w && (v = w.borderTop, c = w.borderLeft), k && (y = k.borderBottom, h = k.borderRight), r = 0; r < d; r++) {
                        for (s = i[r].row === -1 ? 0 : i[r].row, e = i[r].col === -1 ? 0 : i[r].col, i[r].rowCount > 1 && !b && (n = o.getStyle(s, e), n && (a = n.borderBottom), b = !0), i[r].colCount > 1 && !p && (n = o.getStyle(s, e), n && (l = n.borderRight), p = !0), f = 0; f < i[r].colCount; f++) {
                            n = o.getStyle(s, e + f);
                            if (n && v)(n.borderTop === undefined || n.borderTop.color != v.color || n.borderTop.style != v.style) && (v = undefined);
                            else {
                                v = undefined;
                                break
                            }
                        ...
                        for (u = 0; u < i[r].rowCount; u++) {
                            n = o.getStyle(s + u, e);
                            if (n && c)(n.borderLeft === undefined || n.borderLeft.color != c.color || n.borderLeft.style != c.style) && (c = undefined);
                            else {
                                c = undefined;
                                break
                            }
                        ...
                        for (f = 0; f < i[r].colCount; f++) {
                            ...
                            if (n && y)(n.borderBottom === undefined || n.borderBottom.color != y.color || n.borderBottom.style != y.style) && (y = undefined);
                            else {
                                y = undefined;
                                break
                            }
                        ...
                        for (u = 0; u < i[r].rowCount; u++) {
                            ...
                            if (n && h)(n.borderRight === undefined || n.borderRight.color != h.color || n.borderRight.style != h.style) && (h = undefined);
                            else {
                                h = undefined;
                                break
                            }
                        }
                        if (b) for (u = 0; u < i[r].rowCount - 1; u++) for (f = 0; f < i[r].colCount; f++) {
                            n = o.getStyle(s + u, e + f);
                            if (n && a)(n.borderBottom === undefined || n.borderBottom.color != a.color || n.borderBottom.style != a.style) && (a = undefined);
                            else {
                                a = undefined;
                                break
                            }
                        }
                        if (p) for (u = 0; u < i[r].rowCount; u++) for (f = 0; f < i[r].colCount - 1; f++) {
                            n = o.getStyle(s + u, e + f);
                            if (n && l)(n.borderRight === undefined || n.borderRight.color != l.color || n.borderRight.style != l.style) && (l = undefined);
                            else {
                                l = undefined;
                                break
                            }
                ...
                r.prototype._updateBorderPanel = function(i) {
                    ...
                    i.borderTop === undefined || i.borderBottom === undefined || i.borderLeft === undefined || i.borderRight === undefined || o && i.borderHorizontal === undefined || e && i.borderVertical === undefined ? (this._lineStyle = n.LineStyle.thin, this._borderColor = "Text 1", f = t.ColorHelper.parse("Text 1", t.wrapper.spread.getActiveSheet().currentTheme().colors()), this._element.find(".border-picker").wijborderpicker("option", "borderColor", f), this._element.find(".border-picker").wijborderpicker("option", "lineStyle", 1)) : (u = i.borderTop.color, r = i.borderTop.style, u === i.borderBottom.color && (e ? u === i.borderVertical.color: !0) && (o ? u === i.borderHorizontal.color: !0) && u === i.borderLeft.color && u === i.borderRight.color ? (f = t.ColorHelper.parse(u, t.wrapper.spread.getActiveSheet().currentTheme().colors()), this._element.find(".border-picker").wijborderpicker("option", "borderColor", f), this._borderColor = u) : (this._borderColor = "Text 1", f = t.ColorHelper.parse("Text 1", t.wrapper.spread.getActiveSheet().currentTheme().colors()), this._element.find(".border-picker").wijborderpicker("option", "borderColor", f)), r === i.borderBottom.style && (e ? r === i.borderVertical.style: !0) && (o ? r === i.borderHorizontal.style: !0) && r === i.borderLeft.style && r === i.borderRight.style ? (this._element.find(".border-picker").wijborderpicker("option", "lineStyle", r), this._lineStyle = r) : (this._lineStyle = n.LineStyle.thin, this._element.find(".border-picker").wijborderpicker("option", "lineStyle", 1))),
                    setTimeout(function() {
                        s._element.find(".border-sheet").rexcel("refresh")
                    },
                    0)
                },
                r.prototype._getMerged = function() {
                    ...
                    r,
                    n;
                    if (i.length === 1) return n = u.getSpans(i[0]),
                    n.length === 1 && n[0].row === i[0].row && n[0].rowCount === i[0].rowCount && n[0].col === i[0].col && n[0].colCount === i[0].colCount ? !0 : n.length > 0 ? t.BaseMetaObject.indeterminateValue: !1;
                    for (r = 0; r < i.length; r++) {
                        n = u.getSpans(i[r]);
                        if (n.length > 0) return t.BaseMetaObject.indeterminateValue
                    }
                    return ! 1
                },
                ...
                r.prototype._getDecimalInput = function(n, i, r) {
                    var u = $("<div></div>").addClass("sku-numberpicker hidden " + r),
                    f;
                ...
                r.prototype._getSymbolSelect = function(n, i, r) {
                    var f = $("<div></div>").addClass("sku-numberpicker hidden " + r),
                    e,
                    u;
                    for ($("<label><label>").css({
                        "margin-right": "5px"
                    }).text(t.res.formatNumberPickerSetting.symbol).appendTo(f), e = $("<select></select>").attr("size", 1).addClass(i), u = 0; u < n.length; u++) e.append($("<option></option>").text(n[u][0]));
                    return f.append(e),
                    f
                },
                r.prototype._getTypeSelect = function(n, t, i, r) {
                    var l = i + "-container",
                    s = $("<div></div>").addClass("sku-numberpicker hidden " + r + " " + l),
                    ...
                    if (Array.isArray(n)) for (e = 0; e < n.length; e++) u.append($("<option></option>").val(n[e]).text(n[e]));
                    else for (f in n) f.indexOf("red") !== -1 ? u.append($("<option></option>").css("color", "red").val(f).text(n[f])) : u.append($("<option></option>").val(f).text(n[f]));
                ...
                r.prototype._getParagraph = function(n, t) {
                    var i = "wijspread-format-" + t;
                    return $("<p></p>").text(n).addClass("sku-numberpicker hidden " + i)
                },
                r.prototype._getCultureSelect = function(n, t, i, r, u) {
                    var h = i + "-container",
                    s = $("<div></div>").addClass("sku-numberpicker hidden " + r + " " + h),
                    c = "format-number-label",
                    o = $("<div></div>").addClass(c),
                    f,
                    e;
                    ...
                    for (e in n) f.append($("<option></option>").val(e).text(n[e]));
                ...
                r.prototype._initNumberPicker = function() {
                    ...
                    t.find("option").bind("click",
                    function(t) {
                        n._element.find(".sku-numberpicker").addClass("hidden");
                        var i = n._element.find(".category-select option:selected").val(),
                        r = "wijspread-format-" + i;
                        n._element.find(".sku-numberpicker").each(function(n, t) {
                ...
                r.prototype._createDateSetting = function() {
                    for (var n = this,
                    r = [], u = t.res.dateFormats, i = 0; i < u.length; i++) r.push(this._getTextBySpread(this._defaultTime, u[i]));
                    var o = this._getTypeSelect(r, t.res.formatNumberPickerSetting.type, "date-type", "wijspread-format-date"),
                    s = this._getParagraph(t.res.formatNumberComments.dateComments, "date"),
                    f = this._getCultureSelect(t.res.localeType, t.res.formatNumberPickerSetting.locale, "date-type-locale", "wijspread-format-date", "type-locale-select"),
                    e = this._getCultureSelect(t.res.calendarType, t.res.formatNumberPickerSetting.calendar, "date-type-calendar", "wijspread-format-date-calendar");
                ...
                r.prototype._updateDateType = function() {
                    ...
                    switch (s) {
                    case "ja_jp":
                        this._element.find(".wijspread-format-date-calendar").removeClass("hidden"),
                        e = this._element.find(".date-type-calendar-select").find("option:selected").val();
                        if (e === "western") for (o = t.res.japanWesternDateFormat, n = 0; n < o.length; n++) i.push(this._getTextBySpread(this._defaultTime, o[n]));
                        else if (e === "JER") for (u = t.res.japanEmperorReignDateFormat, n = 0; n < u.length; n++) i.push(this._getTextBySpread(this._defaultTime, u[n]));
                        break;
                    case "en_us":
                        for (this._element.find(".wijspread-format-date-calendar").addClass("hidden"), r = t.res.dateFormats, n = 0; n < r.length; n++) i.push(this._getTextBySpread(this._defaultTime, r[n]));
                        break
                    }
                    if (i.length === 0) return;
                    this._element.find(".date-type-container").remove(),
                    f = this._getTypeSelect(i, t.res.formatNumberPickerSetting.type, "date-type", "wijspread-format-date"),
                    f.insertBefore(this._element.find(".date-type-locale-container")),
                    f.removeClass("hidden")
                },
                r.prototype._createCustomSetting = function() {
                    var n = this,
                    f = this._getTypeSelect(t.res.customFormats, t.res.formatNumberPickerSetting.type, "custom-type", "wijspread-format-custom"),
                    u = this._getParagraph(t.res.formatNumberComments.customComments, "custom"),
                    i = $("<div></div>").addClass("custom-type-div custom-class sku-numberpicker hidden wijspread-format-custom"),
                    ...
                    this._element.find(".custom-type-input").bind("input propertychange",
                    function() {
                        n._refreshCustomSample(),
                        n._updateCustomDeleteButton()
                    }),
                ...
                r.prototype._updateCustomFormatter = function(n) {
                    ...
                    if (r) {
                        ...
                        for (e = this._element.find(".custom-type-select"), e.empty(), u = 0; u < i.length; u++) e.append($("<option></option>").val(i[u]).text(i[u]))
                    }
                },
                r.prototype._createTimeSetting = function() {
                    for (var n = this,
                    r = [], u = t.res.timeFormats, i = 0; i < u.length; i++) r.push(this._getTextBySpread(this._defaultTime, u[i]));
                    var o = this._getTypeSelect(r, t.res.formatNumberPickerSetting.type, "time-type", "wijspread-format-time"),
                    e = this._getParagraph(t.res.formatNumberComments.timeComments, "time"),
                    f = this._getCultureSelect(t.res.localeType, t.res.formatNumberPickerSetting.locale, "time-type-locale", "wijspread-format-time", "type-locale-select");
                ...
                r.prototype._updateTimeType = function() {
                    ...
                    switch (e) {
                    case "ja_jp":
                        for (f = t.res.japanTimeFormats, n = 0; n < f.length; n++) i.push(this._getTextBySpread(this._defaultTime, f[n]));
                        break;
                    case "en_us":
                        for (u = t.res.timeFormats, n = 0; n < u.length; n++) i.push(this._getTextBySpread(this._defaultTime, u[n]));
                        break
                    }
                    if (i.length === 0) return;
                    this._element.find(".time-type-container").remove(),
                    r = this._getTypeSelect(i, t.res.formatNumberPickerSetting.type, "time-type", "wijspread-format-time"),
                    r.insertBefore(this._element.find(".time-type-locale-container")),
                    r.removeClass("hidden")
                },
                r.prototype._createPercentageSetting = function() {
                    var n = this,
                    r = this._getDecimalInput("percentage-decimal-places-input", "percentage-decimal-places", "wijspread-format-percentage"),
                ...
                r.prototype._createScientificSetting = function() {
                    var n = this,
                    t = this._getDecimalInput("scientific-decimal-places-input", "scientific-decimal-places", "wijspread-format-scientific");
                ...
                r.prototype._createFractionSetting = function() {
                    var i = this,
                    n = this._getTypeSelect(t.res.fractionType, t.res.formatNumberPickerSetting.type, "fraction-type", "wijspread-format-fraction");
                ...
                r.prototype._createSpecialSetting = function() {
                    var n = this,
                    u = this._getTypeSelect(t.res.specialType, t.res.formatNumberPickerSetting.type, "special-type", "wijspread-format-special"),
                    r = this._getParagraph(t.res.formatNumberComments.specialComments, "special"),
                    i = this._getCultureSelect(t.res.localeType, t.res.formatNumberPickerSetting.locale, "special-type-locale", "wijspread-format-special", "special-locale-select");
                ...
                r.prototype._updateSpecialType = function() {
                    ...
                    i = this._getTypeSelect(n, t.res.formatNumberPickerSetting.type, "special-type", "wijspread-format-special"),
                    i.insertBefore(this._element.find(".special-type-locale-container")),
                    i.removeClass("hidden")
                },
                r.prototype._createAccountingSetting = function() {
                    var n = this,
                    u = this._getDecimalInput("accounting-decimal-places-input", "accounting-decimal-places", "wijspread-format-accounting"),
                    r = this._getSymbolSelect(t.res.accountingSymbol, "accounting-symbol-dropdown", "wijspread-format-accounting"),
                ...
                r.prototype._createNumberSetting = function() {
                    var n = this,
                    u = this._getDecimalInput("decimal-places-input", "decimal-places", "wijspread-format-numbers"),
                    f = this._getSeparatorCheckbox("separator-input", "sku-thousand-separator", "wijspread-format-numbers"),
                    i = this._getTypeSelect(t.res.negativeNumbers, t.res.formatNumberPickerSetting.negativeNumber, "negative-number", "wijspread-format-numbers"),
                ...
                r.prototype._refreshNumberList = function() {
                    ...
                    o;
                    if (h > 0) {
                        for (u = "", r = 0; r < h; r++) u = (r % 10).toString() + u.substring(0);
                        n = n.substring(0, n.indexOf(".") + 1) + u
                    } else n = n.substring(0, n.indexOf("."));
                    c && (e = n.indexOf("1"), n = n.substring(0, e + 1) + "," + n.substring(e + 1));
                    for (f in s) i = n,
                    o = s[f],
                    o.indexOf("-") !== -1 && (i = "-" + i),
                    o.indexOf(")") !== -1 && (i = "(" + i + ")"),
                    this._element.find(".negative-number-select").find("option[value='" + f + "']").text(i)
                },
                r.prototype._refreshCurrencyNumberList = function() {
                    ...
                    s;
                    if (c > 0) {
                        for (u = "", f = 0; f < c; f++) u = (f % 10).toString() + u.substring(0);
                        i = i.substring(0, i.indexOf(".") + 1) + u
                    } else i = i.substring(0, i.indexOf("."));
                    r = this._element.find(".currency-symbol-dropdown").find("option:selected").text(),
                    r === t.res.accountingSymbol[0][0] && (r = ""),
                    o = !0;
                    for (e in h) n = i,
                    s = h[e],
                    s.indexOf("-") !== -1 && o ? (n = "-" + r + n, o = !1) : n = s.indexOf("-") !== -1 ? r + "-" + n: r + n,
                    this._element.find(".currency-type-select").find("option[value='" + e + "']").text(n)
                },
                ...
                r.prototype._refreshCustomInput = function() {
                    if (this._currentFormat) this._element.find(".custom-type-input").val(this._currentFormat);
                    else {
                ...
                r.prototype._refreshScientificSample = function() {
                    var n, i = this._element.find(".scientific-decimal-places-input").val(),
                    r = "",
                    t;
                    if (i > 0) {
                        for (t = 0; t < i; t++) r += "0";
                ...
                r.prototype._refreshDateSample = function() {
                    ...
                    case "ja_jp":
                        ...
                        break;
                    case "en_us":
                        this._element.find(".wijspread-format-date-calendar").addClass("hidden"),
                        n = t.res.dateFormats;
                        break
                    }
                    r = n[u],
                ...
                r.prototype._getCurrencyFormat = function(n, i) {
                    ...
                    o = v[y][1];
                    if (o === null) return r;
                    else if (o === "") for (r = "", a = " $", u = 0; u < c.length; u++) {
                        var f = c[u],
                        e = f.indexOf("[Red]"),
                        h = 5;
                        e !== -1 ? (s = f.substring(0, e + h) + a + f.substring(e + h), r = r + s + ";") : r = r + a + f + ";"
                    } else for (r = "", u = 0; u < c.length; u++) {
                        var f = c[u],
                        e = f.indexOf("[Red]"),
                        h = 5;
                ...
                r.prototype._updateNumberPanelSpreadObject = function(n, t) {
                    ...
                    for ((u === null || u === undefined) && (u = ""), r = 0; r < h; r++) {
                        ...
                        if (n === undefined) {
                            if (u === "") break
                        } else n !== f.getFormatter(o, e) && (n = undefined);
                        u === f.getValue(o, e)
                    }
                ...
                r.prototype._parseFormat = function(n) {
                    ...
                    if (n.indexOf(".") !== -1) {
                        for (c = n.indexOf("."), i = 0, i = c + 1; i < n.length; i++) if (n.substring(i, i + 1) === "0") h++;
                        else break;
                        this._element.find(".format-decimal-input").val(h)
                    }
                    for (y = n.substring(n.indexOf("."), n.indexOf(".") + h + 1), u = n.replace(new RegExp(y, "g"), ""), n.indexOf("$") !== -1 && (u = u.replace(/$/g, "")), i = 0; i < v.length; i++) if (u === v[i]) {
                    ...
                    s = $.inArray(n, ut);
                    if (s < 0) this._element.find(".category-select").val("custom").trigger("change");
                    else {
                ...
                r.prototype._getSelectionDateFormat = function() {
                    ...
                    h,
                    n = f.getSelections(),
                    e = n[0].row === -1 ? 0 : n[0].row,
                    o = n[0].col === -1 ? 0 : n[0].col,
                    s,
                    i,
                    u,
                    c;
                    if (f.getValue(e, o) instanceof Date) h = this._getDateFormat(f.getValue(e, o), e, o);
                    else return null;
                    for (s = 0; s < n.length; s++) {
                        ...
                        l = r.rowCount,
                        a = r.colCount;
                        for (i = e; i < e + l; i++) for (u = o; u < o + a; u++) {
                            c = f.getValue(i, u);
                            if (! (c instanceof Date) || this._getDateFormat(f.getValue(i, u), i, u) !== h) return null
                        }
                    }
                    return h
                },
                r.prototype._getDateFormat = function(n, i, r) {
                    for (var o = t.res.dateFormats,
                    f = t.res.japanWesternDateFormat,
                    s = t.res.japanEmperorReignDateFormat,
                    h = t.wrapper.spread.getActiveSheet(), e = h.getText(i, r), u = 0; u < o.length; u++) if (this._getTextBySpread(n, o[u]) === e) return o[u];
                    for (u = 0; u < f.length; u++) if (this._getTextBySpread(n, f[u]) === e) return f[u];
                    for (u = 0; u < s.length; u++) if (this._getTextBySpread(n, s[u]) === e) return s[u]
                },
                r.prototype._isDateFormat = function(n) {
                    ...
                    r = "1992";
                    if (n.indexOf("G") !== -1 || n.indexOf("g") !== -1 || n.indexOf("e") !== -1) return n;
                    for (i = 0; i < e.length; i++) {
                        u = this._getTextBySpread(r, e[i]),
                        f = this._getTextBySpread(r, n);
                        if (u === f && e[i].indexOf(n) !== -1) return e[i]
                    }
                    for (i = 0; i < s.length; i++) {
                        u = this._getTextBySpread(r, s[i]),
                        f = this._getTextBySpread(r, n);
                        if (u === f && s[i].indexOf(n) !== -1) return s[i]
                    }
                    for (i = 0; i < o.length; i++) {
                        u = this._getTextBySpread(r, o[i]),
                        f = this._getTextBySpread(r, n);
                        if (u === f && o[i].indexOf(n) !== -1) return o[i]
                    }
                    return ! 1
                },
