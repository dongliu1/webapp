		...
		(function (i) {
			...
			i.SortDialog = function (n) {
				...
				t.prototype._getSortByOptions = function () {
					...
					if (this._byRows) for (u = o.col, u = u == -1 ? 0 : u, n = 0; n < o.colCount; n++) t = $("<option></option>"),
					t.text("Column " + f.getCell(f.getRowCount(1) - 1, u + n, 1).text()),
					t.val(u + n),
					e.append(t);
					else for (r = o.row, r = r == -1 ? 0 : r, n = 0; n < o.rowCount; n++) t = $("<option></option>"),
					t.text("Row " + (r + n + 1).toString()),
					t.val(r + n),
					e.append(t);
					return e
				}
				...
				t.prototype._addLevel = function () {
					...
					n.append(this._sortByOptions.clone(!0)),
				...
				t.prototype._sortOption = function () {
					var n = this;
					this._sortOptionDialog || (this._sortOptionDialog = new o(n)),
				...
				t.prototype.sort = function () {
					...
					u.children().each(function (n, t) {
							var f = !0,
								u, i;
							$(t).find(".sort-order").val() == "Z to A" && (f = !1),
							u = $(t).find(".sort-row-sortby").val(),
							i = {
									index: u,
									ascending: f
								},
			...
			i.SpreadSettingDialog = function (n) {
				function t() {
					var t = this,
						r = {
							width: "auto",
			...
			i.SheetSettingDialog = function (n) {
				function r() {
					var t = this,
						r = {
							width: "auto",
					...
					console.log("to---------open",r)
					n.call(this, "./dialogs/dialogs2.html", ".sheet-setting-dialog", r)
				}
				__extends(r, n);
				r.prototype._init = function () {
					console.log("SheetSettingDialog init")
					var n = this;
					...
					this._element.find("#gridline-color-picker").wijcolorpicker({
					...
					this._element.find("#gridline-color-frame").wijcomboframe(),
					this._element.find("#sheettab-color-picker").wijcolorpicker({
						valueChanged: function (t, i) {
				...
				r.prototype._beforeOpen = function (n) {
					...
					r.sheetTabColor() ? (u = i.ColorHelper.parse(r.sheetTabColor(), r.currentTheme().colors()), $("#sheettab-color-picker").wijcolorpicker("option", "selectedItem", u), this._element.find("#sheettab-color-span").css("background-color", u.color)) : (this._element.find("#sheettab-color-span").css("background-color", "transparent"), $("#sheettab-color-picker").wijcolorpicker("option", "selectedItem", null))
				}
				r.prototype._applySetting = function () {
					...
					u = $("#gridline-color-picker").wijcolorpicker("option", "selectedItem"),
					...
					r = $("#sheettab-color-picker").wijcolorpicker("option", "selectedItem"),
			...
			i.DataValidationDialog = function (r) {
				function u() {
					var n = this,
						t = {
							width: "auto",
				...
				u.prototype._ValidValues = function () {
					var n = this._value1.val(),
						t = this._value2.val();
					if (this._value1.css("visibility") == "visible" && this._value2.css("visibility") == "hidden") if (!n) return i.MessageBox.show(i.res.dataValidationDialog.valueEmptyMessage, i.res.title, 1, 0),
					!1;
					if (this._value1.css("visibility") == "visible" && this._value2.css("visibility") == "visible") if (n && t) {
							if ($.isNumeric(n) && $.isNumeric(t)) if (Number(n) > Number(t)) return i.MessageBox.show(i.res.dataValidationDialog.minimumMaximumMessage, i.res.title, 1, 0),
							!1
						} else return i.MessageBox.show(i.res.dataValidationDialog.valueEmptyMessage, i.res.title, 1, 0),
					!1;
					return !0
				};
				return u;
			}(i.BaseDialog);
			i.GroupDirectionDialog = function (n) {
				function t() {
					var t = this,
						r = {
							width: "auto",
			...
			i.ZoomDialog = function (n) {
				...
				t.prototype._beforeOpen = function () {
					...
					this._findFitRatio(n._zoomFactor)
				},
				t.prototype._init = function () {
					var n = this,
						r = i.wrapper.spread.getActiveSheet(),
			...
			i.CreateTableDialog = function (n) {
				function t() {
					var t = this,
						r = {
							width: "auto",
			...
			i.FormatTableDialog = function (n) {
				function r() {
					var t = this,
						u = {
							width: 600,
				...
				r.prototype._createTablePreview = function () {
					...
					for (this._element.find(".pre-spread").wijspread(), this._tableFormatSpread = this._element.find(".pre-spread").wijspread("spread"), n = this._tableFormatSpread.getActiveSheet(), this._tableFormatSpread.showHorizontalScrollbar(!1), this._tableFormatSpread.showVerticalScrollbar(!1), this._tableFormatSpread.tabStripVisible(!1), this._tableFormatSpread.allowUserResize(!1), n.isPaintSuspended(!0), $(n._canvas).unbind("gcmousewheel.gcSheet"), n.currentTheme(i.wrapper.spread.getActiveSheet().currentTheme()), n.setGridlineOptions({
						...
						}), n.colHeaderVisible = !1, n.rowHeaderVisible = !1, n.canUserDragDrop(!1), n.canUserDragFill(!1), n.selectionBackColor("transparent"), n.selectionBorderColor("transparent"), n.isProtected = !0, n.setColumnCount(8), n.setRowCount(9), r = 1; r < 8; r++) for (u = 1; u < 7; u++) n.setValue(r, u, "-"),
					n.getCell(r, u).vAlign($.sku.wijspread.VerticalAlign.center),
			...
			i.ResizeTableDialog = function (n) {
				function r() {
					var t = this,
						r = {
							width: "auto",
			...
			i.FormatCommentDialog = function (n) {
				function r() {
					var t = this,
						r = {
							width: "auto",
				...
				r.prototype._beforeOpen = function (n) {
					var r, u, t;
					this._wijspread = i.wrapper.spread,
					r = this._wijspread.getActiveSheet();
					if (!r) return;
				...
				r.prototype._updateFont = function () {
					...
					n.wijfontpicker("family", this._font.family),
					n.wijfontpicker("style", this._font.style ? this._font.style : "normal"),
					t = this._font.size,
					t.indexOf("px") !== -1 && (t = i.util.px2pt(parseInt(t))),
					n.wijfontpicker("size", parseInt(t)),
					n.wijfontpicker("weight", this._font.weight ? this._font.weight : "normal"),
					this._font.foreColor ? n.wijfontpicker("color", i.ColorHelper.parse(this._font.foreColor, i.wrapper.spread.getActiveSheet().currentTheme().colors())) : n.wijfontpicker("color", null),
					this._font.textDecoration & 1 ? n.wijfontpicker("underline", !0) : n.wijfontpicker("underline", !1),
					this._font.textDecoration & 2 ? n.wijfontpicker("strikethrough", !0) : n.wijfontpicker("strikethrough", !1)
				},
				...
				r.prototype._setColorsAndLines = function () {
					...
					if (!t) return;
					n = o._fillStyle,
					n.color !== t.backColor() && i.actions.doAction("setCommentProperty", this._wijspread, {
				...
				r.prototype._updateColorsAndLines = function () {
					...
					this._fillColorPicker.wijcolorpicker("option", "selectedItem", t),
					...
					n && (this._lineColorPicker.wijcolorpicker("option", "selectedItem", n), this._element.find(".comment-line").css("background-color", n)),
			...
			bt = i.FormulaSparklineType;

			(function (n) {
				n[n.cascade = 0] = "cascade",
				n[n.pareto = 1] = "pareto"
			})(i.MultiRangeFormulaType || (i.MultiRangeFormulaType = {}));
			pt = i.MultiRangeFormulaType;

			i.InsertSparkLineDialog = function (n) {
				function t() {
					var t = this,
						r = {
							width: "auto",
			...
			i.SparklineWeightDialog = function (n) {
				function t() {
					var t = this,
						r = {
							width: "200",
			...
			i.SparklineMarkerColorDialog = function (n) {
				function t() {
					var t = this,
						r = {
							width: "auto",
				...
				t.prototype._loadColor = function (n, t, r) {
					...
					n ? (u = i.ColorHelper.parse(n, f.currentTheme().colors()), $("." + r).wijcolorpicker("option", "selectedItem", u), this._element.find("." + t).css("background-color", u.color)) : (this._element.find("." + t).css("background-color", "transparent"), $("." + r).wijcolorpicker("option", "selectedItem", null))
				},
				...
				t.prototype._applySetting = function () {
					this._saveColor($(".sparkline-negative-point-color-picker").wijcolorpicker("option", "selectedItem"), "setSparklineNegativeColor"),
					this._saveColor($(".sparkline-marker-point-color-picker").wijcolorpicker("option", "selectedItem"), "setSparklineMarkerColor"),
					this._saveColor($(".sparkline-high-point-color-picker").wijcolorpicker("option", "selectedItem"), "setSparklineHighColor"),
					this._saveColor($(".sparkline-low-point-color-picker").wijcolorpicker("option", "selectedItem"), "setSparklineLowColor"),
					this._saveColor($(".sparkline-first-point-color-picker").wijcolorpicker("option", "selectedItem"), "setSparklineFirstColor"),
					this._saveColor($(".sparkline-last-point-color-picker").wijcolorpicker("option", "selectedItem"), "setSparklineLastColor")
				},
				t
			}(i.BaseDialog);
			i.PieSparklineDialog = function (n) {
				function t() {
					var t = this,
						r = {
							modal: !0,
				...
				t.prototype._beforeOpen = function (n) {
					...
					if (o.args) {
							...
							else if (u < e) for (t = 0; t < e - u; t++) l = this._element.find(".remove-pie-color"),
							l.length > 0 && $(l[0]).trigger("click");
							if (u === 0) h = i.ColorHelper.parse(this._defaultValue.color, this._sheet.currentTheme().colors()),
							$(".pie-color-picker1-widget").wijcolorpicker("option", "selectedItem", h),
							this._element.find(".pie-color-picker1").css("background-color", h.color);
							else for (t = 1; t <= u; t++) {
								f = null,
								...
								$(".pie-color-picker" + t + "-widget").wijcolorpicker("option", "selectedItem", f),
				...
				t.prototype._applySetting = function () {
					var e = this._element.find(".pie-percentage").val(),
						...
						t = [],
						f, r, u, n, h, s;
					for (t.push(e), n = 0; n < o; n++) f = n + 1,
					r = $(".pie-color-picker" + f + "-widget").wijcolorpicker("option").selectedItem,
					(o !== 1 || r.baseColor !== this._defaultValue.color) && r && r.color && t.push(r.color);
				...
				t.prototype._removePieColor = function (n) {
					...
					t.length > 0 && (t.wijcolorpicker("destroy"), t.parents("div.color-picker-popup").remove()),
				...
				t.prototype._createColorPicker = function (n, t) {
					...
					return f.wijcolorpicker("option", "themeColors", i.wrapper.getThemeColors()),
					r.wijcomboframe().click(function (n) {
			...
			i.AreaSparklineDialog = function (n) {
				function t() {
					var t = this,
						r = {
							modal: !0,
				...
				t.prototype._applySetting = function () {
					...
					n = $(".negative-color-picker").wijcolorpicker("option").selectedItem,
					r = "",
				...
				t.prototype._beforeOpen = function (n) {
					...
					if (a.args) {
							...
							$(".positive-color-picker").wijcolorpicker("option", "selectedItem", u),
							...
							$(".negative-color-picker").wijcolorpicker("option", "selectedItem", u),
			...
			i.ScatterSparklineDialog = function (n) {
				function u() {
					var t = this,
						r = {
							modal: !0,
				...
				u.prototype._applySetting = function () {
					for (var f = this._paraPool, n = "", t, u, r = 0; r < f.length; r++) t = f[r],
					n += t != undefined && t != null ? t + "," : ",";
				...
				u.prototype._beforeOpen = function (n) {
					...
					if (w.args) {
							var u = w.args,
								...
								d = p.length;
							for (f = 0; f < d; f++) s = "",
							u[f] && (s = i.util.unParseFormula(u[f], c, h)),
							this._element.find(p[f]).val(s),
							this._paraPool.push(s);
				...
				u.prototype._updateColorPicker = function (n, t) {
					...
					if (t) {
						...
						} else u.wijcolorpicker("option", "selectedItem", null),
					this._element.find("." + n + "-span").css("background-color", "transparent")
				},
			...
			i.CompatibleSparklineDialog = function (u) {
				function f() {
					var n = this,
						t = {
							modal: !0,
				...
				f.prototype._parseSetting = function (n) {
					var r = {},
						...
						o, c, t, u, i;
					if (n) {
							for (n = n.substr(1, n.length - 2), o = 0, c = n.length; o < c; o++) t = n.charAt(o),
							t === ":" ? s = !1 : t !== "," || h ? t !== "'" && t !== '"' && (t === "(" ? h = !0 : t === ")" && (h = !1), s ? f += t : e += t) : (r[f] = e, f = "", e = "", s = !0);
							f && (r[f] = e);
							for (u in r) i = r[u],
							i !== null && typeof i != "undefined" && (i.toUpperCase() === "TRUE" ? r[u] = !0 : i.toUpperCase() === "FALSE" ? r[u] = !1 : !isNaN(i) && isFinite(i) && (r[u] = parseFloat(i)))
						}
					return r
				},
				...
				f.prototype._init = function () {
					...
					this._styleSettingDialog || (this._styleSettingDialog = new i.CompatibleStyleSettingDialog),
					this._attachEvent()
				},
				...
				f.prototype._applySetting = function () {
					...
					if (r.length >= 250) {
							u = [];
							for (n in this._sparklineSetting) this._sparklineSetting[n] !== undefined && this._sparklineSetting[n] !== "" && u.push(this._shortenFormula(n, !0) + ":" + this._shortenFormula(this._sparklineSetting[n])),
							f = '"{' + u.join(",") + '}"',
							r = "=" + this._sparklineName + "(" + e + "," + s + "," + h + "," + o + "," + f + ")"
						}
					i.actions.doAction("setFormulaSparkline", i.wrapper.spread, {
							formula: r,
							type: 3,
				...
				f.prototype._shortenFormula = function (t, i) {
					var o, u, e, f, r;
					if (i) return o = this._shortDic[t.toLowerCase()],
					o ? o : t;
						...
						if (t.indexOf("rgb") !== -1) {
							...
							if (u && u.length > 0) for (e = "#", f = 0; f < u.length; f++) r = u[f].toString(16),
							r.length === 1 && (r = "0" + r),
							e += r;
							if (e !== "#") return e
						}
			...
			i.CompatibleStyleSettingDialog = function (n) {
				function t() {
					var t = this,
						r = {
							modal: !0,
				...
				t.prototype._createColorPicker = function (n, t, r) {
					...
					s.wijcolorpicker("option", "themeColors", i.wrapper.getThemeColors()),
					u.wijcomboframe().click(function (n) {
			...
			u = function (n) {
				...
				t.prototype.updateColorPicker = function (n, t, r) {
					...
					if (r) {
						...
						} else f.wijcolorpicker("option", "selectedItem", null),
					this._element.find("." + t).css("background-color", "transparent")
				},
				...
				t.prototype.createColorPicker = function (n, t, r) {
					...
					this._element.find("." + r).wijcolorpicker("option", "themeColors", i.wrapper.getThemeColors()),
					this._element.find("." + n).wijcomboframe()
				},
				t
			}(i.BaseDialog);
			i.SparklineExBaseDialog = u;
			i.BulletSparklineDialog = function (n) {
				function u() {
					var t = this,
						r = {
							modal: !0,
				...
				u.prototype.applySetting = function () {
					for (var e = this._paraPool, n = "", r, o, f, u = 0; u < e.length; u++) r = e[u],
					n += r !== undefined && r !== null ? r + "," : ",";
			...
			i.SpreadSparklineDialog = function (n) {
				function u() {
					var t = this,
						r = {
							modal: !0,
			...
			i.StackedSparklineDialog = function (n) {
				function u() {
					var t = this,
						r = {
							modal: !0,
			...
			i.BarBaseSparklineDialog = function (n) {
				function u(t, i, r) {
					n.call(this, t, i, r)
				}
				return __extends(u, n),
				...
				u.prototype.applySetting = function (n) {
					for (var s = this._paraPool, r = "", u, o, e, f = 0; f < s.length; f++) u = s[f],
					r += u !== undefined && u !== null ? u + "," : ",";
			...
			i.HbarSparklineDialog = function (n) {
				function t() {
					var t = this,
						r = {
							modal: !0,
				...
				return __extends(t, n),
				t
			}(i.BarBaseSparklineDialog),
			i.VbarSparklineDialog = function (n) {
				function t() {
					var t = this,
						r = {
							modal: !0,
			...
			i.VariSparklineDialog = function (n) {
				function u() {
					var t = this,
						r = {
							modal: !0,
			...
			i.BoxPlotSparklineDialog = function (n) {
				function u() {
					var t = this,
						r = {
							modal: !0,
			...
			i.CascadeSparklineDialog = function (n) {
				function u() {
					var t = this,
						r = {
							modal: !0,
			...
			i.ParetoSparklineDialog = function (n) {
				function r() {
					var t = this,
						r = {
							modal: !0,
			...
			r = function () {
				function n() {}
				n.parseColorExpression = function (n, r, u) {
					var e, f;
					if (!n) return null;
