	...
	(function(t) {
		(function(i) {
			var wt = function(n) {
				...
				ft, o, et, ot, ut, tt, it, bt, pt, rt, st, vt, yt, ct, ht, at, k, lt, l, c, v, a, e, u, h, s, d, f, nt, g, p, y, b, w, r;
			i.FillDialog = wt, ft = function(n) {
				function t() {
					var t = this,
						r = {
							width: "auto",
			...
			}(i.BaseDialog), i.SortDialog = ft, o = function(n) {
				function t(t) {
					var r = this,
						u = {
							width: "auto",
			...
			}(i.BaseDialog), i.SortOptionDialog = o, et = function(n) {
				function t() {
					var t = this,
						r = {
							width: "auto",
			...
			}(i.MultiRangeFormulaType || (i.MultiRangeFormulaType = {})), pt = i.MultiRangeFormulaType, rt = function(n) {
				function t() {
					var t = this,
						r = {
							width: "auto",
