	...
	(function(n) { 
		(function(n) {
            ...
            t = function() {
                function t(n, t, i) {
                    this._options = i;
                    if (this._options.autoOpen) throw "AutoOpen is not support.";
                    this.updateOptions(),
                ...
                t.prototype.onInit = function() {
                    ...
                    this._element.parent().on("keypress",
                    function(t) {
                        if (t.keyCode === 13) {
                            var i = n._element.parent().find("button[skuDialogToBeFocused='true']");
                    ...
                    this._element.dialog({
                        open: function() {
                            ...
                            n._element.parent().find("button[skuDialogToBeFocused='true']").focus()
                        }
                    })
                },
                ...
                t.prototype.updateOptions = function() {
                    ...
                    this._options.buttons && this._options.buttons[0] && (this._options.buttons[0].skuDialogToBeFocused = "true")
                },
                t
            } ();
            n.BaseDialog = t
